...
public class RequestHandler {
     ...
     * @param receivePacket = DatagramPacket received in the DNS server
    ...
    public static byte[] handle(DatagramPacket receivePacket) throws UnknownHostException {
        ...
        int[] toSend = pdns.getAnswer(DNSDatabase.get(domain), receivePacket.getLength());
    ...
    private static void debugHandle(DatagramPacket receivePacket) {
        ...
        System.out.println("> Received DNS request (" + length + ") from " + ipAddress);
    }
